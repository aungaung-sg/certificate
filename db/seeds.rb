...
Theme.create(name: "theme1", color_code: "#204d74")

User.create(email: "admin@mail.com", password: "password1!", password_confirmation: "password1!", admin: true, name: "admin", theme_id: 1)
User.create(email: "pyay@mail.com", password: "password1!", password_confirmation: "password1!", admin: false, name: "Pyay", theme_id: 1)
User.create(email: "paukkhaung@mail.com", password: "password1!", password_confirmation: "password1!", admin: false, name: "Pauk Khaung",  theme_id: 1)
User.create(email: "magway@mail.com", password: "password1!", password_confirmation: "password1!", admin: false, name: "Magway", theme_id: 1)
User.create(email: "dawei@mail.com", password: "password1!", password_confirmation: "password1!", admin: false, name: "Dawei", theme_id: 1)
User.create(email: "minhla@mail.com", password: "password1!", password_confirmation: "password1!", admin: false, name: "Min Hla", theme_id: 1)
User.create(email: "pakokku@mail.com", password: "password1!", password_confirmation: "password1!", admin: false, name: "Pakokku", theme_id: 1)
User.create(email: "nattalin@mail.com", password: "password1!", password_confirmation: "password1!", admin: false, name: "Nattalin", theme_id: 1)
User.create(email: "aunglan@mail.com", password: "password1!", password_confirmation: "password1!", admin: false, name: "Aung Lan", theme_id: 1)
User.create(email: "tamwe@mail.com", password: "password1!", password_confirmation: "password1!", admin: false, name: "Tamwe", theme_id: 1)
User.create(email: "tingunkyun@mail.com", password: "password1!", password_confirmation: "password1!", admin: false, name: "Thingunkyun",  theme_id: 1)
User.create(email: "Latha@mail.com", password: "password1!", password_confirmation: "password1!", admin: false, name: "Latha",  theme_id: 1)
